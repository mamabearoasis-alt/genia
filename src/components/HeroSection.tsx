  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-white via-blue-50 to-purple-50">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 py-20 text-center">
        <div className="inline-flex items-center gap-2 px-4 py-2 bg-white/80 backdrop-blur-sm rounded-full border border-blue-200 mb-8 animate-[fadeIn_0.6s_ease-out]">
          <Sparkles className="w-4 h-4 text-blue-600" />
          <span className="text-sm font-medium text-gray-700">Creatividad potenciada por IA</span>
        </div>

        <h1 className="text-5xl md:text-7xl font-bold text-gray-900 mb-6 leading-tight animate-[fadeIn_0.8s_ease-out]">
        ...
        <p className="text-xl md:text-2xl text-gray-600 mb-12 max-w-3xl mx-auto animate-[fadeIn_1s_ease-out]">
          Videos, imágenes y branding diseñados con IA para escalar tu eCommerce sin depender de equipos humanos
        </p>

        <button
          onClick={scrollToDemo}
          className="group relative px-8 py-4 bg-gradient-to-r from-blue-600 to-purple-600 text-white text-lg font-semibold rounded-full hover:shadow-2xl hover:shadow-cyan-400/50 transition-all duration-300 hover:scale-105 animate-[fadeIn_1.2s_ease-out]"
        >
        ...
        <div className="flex flex-wrap items-center justify-center gap-8 mt-12 text-gray-600 animate-[fadeIn_1.4s_ease-out]">
        ...
        <div className="mt-20 relative max-w-5xl mx-auto animate-[fadeIn_1.6s_ease-out]">
